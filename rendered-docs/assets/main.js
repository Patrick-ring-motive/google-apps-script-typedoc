(() => {
  ...
  document.onload = () => {
    ...
    [...document.querySelectorAll('a[href*="variables/google-apps-script-events"]')].forEach(x => {
      x.href = x.href.replace('variables', 'interfaces')
    });
  ...
  (() => {
    ...
    var tt = (t, e, n, r) => {
      if (e && typeof e == "object" || typeof e == "function")
        for (let i of Ze(e)) !Ye.call(t, i) && i !== n && he(t, i, {
          get: () => e[i],
          enumerable: !(r = Ge(e, i)) || r.enumerable
        });
      return t
    };
    var nt = (t, e, n) => (n = t != null ? Ke(Xe(t)) : {}, tt(e || !t || !t.__esModule ? he(n, "default", {
      value: t,
      enumerable: !0
    }) : n, t));
    var ye = et((me, ge) => {
...
`, e)
        ...
        t.Vector = function(e) {
          ...
          for (var n = 0, r = this.elements, i = e.elements, s = r.length, o = i.length, a = 0, c = 0, l = 0, d = 0; l < s && d < o;) a = r[l], c = i[d], a < c ? l += 2 : a > c ? d += 2 : a == c && (n += r[l + 1] * i[d + 1], l += 2, d += 2);
          return n
        ...
        t.stemmer = (function() {
          var e = {
            ...
            V = function(u) {
              ...
              if (k = u.substr(0, 1), k == "y" && (u = k.toUpperCase() + u.substr(1)), h = w, E = m, h.test(u) ? u = u.replace(h, "$1$2") : E.test(u) && (u = u.replace(E, "$1$2")), h = g, E = T, h.test(u)) {
                var b = h.exec(u);
        ...
        t.TokenSet = function() {
          ...
          for (var r = new t.TokenSet, i = [{
            ...
            if (s.editsRemaining != 0) {
              ...
              if (s.str.length == 0 && (c.final = !0), i.push({
                  node: c,
              ...
              if (s.str.length > 1) {
                var d = s.str.charAt(0),
                  f = s.str.charAt(1),
                  p;
                f in s.node.edges ? p = s.node.edges[f] : (p = new t.TokenSet, s.node.edges[f] = p), s.str.length == 1 && (p.final = !0), i.push({
                  node: p,
                  editsRemaining: s.editsRemaining - 1,
                  str: d + s.str.slice(2)
                })
              ...
              for (var d = s[l], f = 0; f < c; f++) {
                ...
                if (p == d || d == "*") {
                  var v = r.node.edges[p],
                    ...
                    w = v.final && x.final,
                    m = void 0;
                  p in r.output.edges ? (m = r.output.edges[p], m.final = m.final || w) : (m = new t.TokenSet, m.final = w, r.output.edges[p] = m), i.push({
                    qNode: x,
                    output: m,
                    node: v
                  })
        ...
        t.Index = function(e) {
          ...
          for (var n = new t.Query(this.fields), r = Object.create(null), i = Object.create(null), s = Object.create(null), o = Object.create(null), a = Object.create(null), c = 0; c < this.fields.length; c++) i[this.fields[c]] = new t.Vector;
          e.call(n, n);
          for (var c = 0; c < n.clauses.length; c++) {
            var l = n.clauses[c],
              d = null,
              f = t.Set.empty;
            l.usePipeline ? d = this.pipeline.runString(l.term, {
              fields: l.fields
            }) : d = [l.term];
            for (var p = 0; p < d.length; p++) {
              ...
              for (var T = 0; T < w.length; T++)
                for (var L = w[T], C = this.invertedIndex[L], O = C._index, m = 0; m < l.fields.length; m++) {
                  ...
                  if (i[g].upsert(O, l.boost, function(Ue, Je) {
                      return Ue + Je
                    }), !s[q]) {
    ...
    var Z = class {
      ...
      updateIndexVisibility() {
        let e = document.querySelector(".tsd-index-content"),
          n = e?.open;
        e && (e.open = !0), document.querySelectorAll(".tsd-index-section").forEach(r => {
      ...
      listenForCodeCopies() {
        document.querySelectorAll("pre > button").forEach(e => {
          ...
          e.addEventListener("click", () => {
            e.previousElementSibling instanceof HTMLElement && navigator.clipboard.writeText(e.previousElementSibling.innerText.trim()), e.textContent = window.translations.copied, e.classList.add("visible"), clearTimeout(n), n = setTimeout(() => {
              e.classList.remove("visible"), n = setTimeout(() => {
    ...
    var ee = class extends I {
      ...
      value;
      constructor(e) {
        super(e), this.key = `filter-${this.el.name}`, this.value = this.el.checked, this.el.addEventListener("change", () => {
          this.setLocalStorage(this.el.checked)
        }), this.setLocalStorage(this.fromLocalStorage()), be.innerHTML += `html:not(.${this.key}) .tsd-is-${this.el.name} { display: none; }
`, this.app.updateIndexVisibility()
      ...
      handleValueChange() {
        this.el.checked = this.value, document.documentElement.classList.toggle(this.key, this.value), le[`tsd-is-${this.el.name}`] = this.value, this.app.filterChanged(), this.app.updateIndexVisibility()
      }
    };
    var Le = 0;
    ...
    function _e() {
      ...
      o.base.endsWith("/") || (o.base += "/"), i.addEventListener("error", () => {
    ...
    function ot(t, e) {
      ...
      o.addEventListener("click", a), n.addEventListener("input", fe(() => {
        at(r, n, s, e)
      }, 200)), n.addEventListener("keydown", l => {
      ...
      n.addEventListener("change", c), n.addEventListener("blur", c), n.addEventListener("click", c), document.body.addEventListener("keydown", l => {
    ...
    function Te(t, e, n, r) {
      let i;
      if (r === 1 ? i = n?.nextElementSibling || t.firstElementChild : i = n?.previousElementSibling || t.lastElementChild, i !== n) {
        if (!i || i.role !== "option") {
          console.error("Option missing");
          return
        }
        i.ariaSelected = "true", i.scrollIntoView({
          behavior: "smooth",
          block: "nearest"
        }), e.setAttribute("aria-activedescendant", i.id), n?.setAttribute("aria-selected", "false")
      }
    }
    ...
    function ut() {
      ...
      return t ? t.isContentEditable || t.tagName === "TEXTAREA" || t.tagName === "SEARCH" ? !0 : t.tagName === "INPUT" && !ct.includes(t.type) : !1
    }
    var D = "mousedown",
      Me = "mousemove",
      $ = "mouseup",
    ...
    var re = class extends I {
      ...
      className;
      constructor(e) {
        super(e), this.className = this.el.dataset.toggle || "", this.el.addEventListener($, n => this.onPointerUp(n)), this.el.addEventListener("click", n => n.preventDefault()), document.addEventListener(D, n => this.onDocumentPointerDown(n)), document.addEventListener($, n => this.onDocumentPointerUp(n))
      }
      setActive(e) {
    ...
    var ue = new Map,
      de = class {
        ...
        add(e) {
          this.accordions.push(e), e.open = this.open, e.addEventListener("toggle", () => {
            this.toggle(e.open)
          })
        }
        toggle(e) {
    ...
    function He(t) {
      ...
      t.value = e, Ae(e), t.addEventListener("change", () => {
    ...
    async function Ve() {
      ...
      s.classList.add("tsd-hierarchy-toggle"), s.textContent = window.translations.hierarchy_expand, t.querySelector("h4 a")?.insertAdjacentElement("afterend", s), s.insertAdjacentText("beforebegin", ", "), s.addEventListener("click", () => {
        s.textContent === window.translations.hierarchy_expand ? (r.insertAdjacentElement("afterend", i), r.remove(), s.textContent = window.translations.hierarchy_collapse) : (i.insertAdjacentElement("afterend", r), i.remove(), s.textContent = window.translations.hierarchy_expand)
      })
    }
    ...
    function gt() {
      ...
      return t.setAttribute("width", "20"), t.setAttribute("height", "20"), t.setAttribute("viewBox", "0 0 24 24"), t.setAttribute("fill", "none"), t.innerHTML = '<use href="#icon-chevronDown"></use>', t
    }
    X(re, "a[data-toggle]");
    X(ie, ".tsd-accordion");
